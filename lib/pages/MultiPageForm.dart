...
class _MultiPageFormState extends State<MultiPageForm> {
  ...
  Future<void> _loadLanguage() async {
    ...
    // Set _isEnglish based on language preference
    _isEnglish = language == 'en';
    setState(() {}); // Trigger a rebuild to reflect the new language setting
  }
  ...
  Widget build(BuildContext context) {
    TextDirection textDirection = _isEnglish ? TextDirection.ltr : TextDirection.rtl;
    return Scaffold(
